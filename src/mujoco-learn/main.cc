...
void ThreadMujoco() {  // print version, check compatibility
  ...
  // const char* filename = "/home/tlbot/code/gac-robotics/sim/model/g1_description/g1.xml";
  // const char* filename = "/home/tlbot/code/gac-robotics/sim/model/g1_description/g1_new.xml";
  // const char* filename = "/home/tlbot/code/gac-robotics/sim/model/Y3A/xml/y3aurdf20240815.xml";
  const char* filename = "/home/tlbot/code/ros2_bazel_test/sim/model/doublependulum.xml";
  // if (argc > 1) {
  //   filename = argv[1];
  // }
...
int main(int argc, char* argv[]) {
  ...
  std::thread mujoco_thread_handle(&ThreadMujoco);
  // mujoco_thread_handle.join();
